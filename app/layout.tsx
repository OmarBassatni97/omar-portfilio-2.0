...
import ActiveSectionContextProvider from '@/context/live-section-context'

const inter = Inter({ subsets: ['latin'] })

export const metadata: Metadata = {
  title: 'Omar Bassatni',
  description: 'Omar Bassatni is a Frontend Developer specialized in Reactjs and Nextjs',
}
    ...
    <html lang="en" className='!scroll-smooth'>
      <body className={`${inter.className}
       bg-gray-50 text-gray-950 relative pt-28 sm:pt-36`}>
        ...
        sm:w-[68.65rem] md:left-[-33rem] lg:left[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]'></div>
